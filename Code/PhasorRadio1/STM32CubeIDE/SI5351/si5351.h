...
void si5351_SetupCLK0(uint32_t Fclk, si5351DriveStrength_t driveStrength);
void si5351_SetupCLK2(uint32_t Fclk, si5351DriveStrength_t driveStrength);
 ...
 */
void si5351_Calc(uint32_t Fclk, si5351PLLConfig_t *pll_conf,
 ...
 */
void si5351_CalcIQ(uint32_t Fclk, si5351PLLConfig_t *pll_conf,
		si5351OutputConfig_t *out_conf);
