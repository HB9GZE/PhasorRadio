...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_1|GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_15
                          |GPIO_PIN_11);

    HAL_GPIO_DeInit(GPIOG, GPIO_PIN_14|GPIO_PIN_7);

    HAL_GPIO_DeInit(GPIOH, GPIO_PIN_15|GPIO_PIN_11|GPIO_PIN_9|GPIO_PIN_2
                          |GPIO_PIN_8|GPIO_PIN_10|GPIO_PIN_4|GPIO_PIN_3);
